...
- [6. Makefile Variable Reference](#6-makefile-variable-reference)
    - [Common `CORE_ARGS` Flags](#common-core_args-flags)
        ...
        - [Opponent Call Settings](#opponent-call-settings)
        - [Opponent Time Settings](#opponent-time-settings)
        - [Deployment Transaction Settings](#deployment-transaction-settings)
