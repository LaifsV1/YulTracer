...
// original: pragma solidity >=0.6.8 <0.8.0;
            ...
            _getFeeGrowthInside(
                IUniswapV3Pool(
                    PoolAddress.computeAddress(
                        ...
                        PoolAddress.getPoolKey({token0: feeParams.token0, token1: feeParams.token1, fee: feeParams.fee})
            //VK changed above line to fix bug 'require(key.token0 < key.token1)' failing in PoolAddress.computeAddress:
