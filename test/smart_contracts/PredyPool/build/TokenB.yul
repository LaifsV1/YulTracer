...
object "TokenB_78" {
    code {
        /// @src 49:1434:1559  "contract TokenB is AERC20 {..."
        mstore(64, memoryguard(128))
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        constructor_TokenB_78()

        let _1 := allocate_unbounded()
        codecopy(_1, dataoffset("TokenB_78_deployed"), datasize("TokenB_78_deployed"))

        return(_1, datasize("TokenB_78_deployed"))
        ...
        function store_literal_in_memory_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2(memPtr) {

            mstore(add(memPtr, 0), "TokenB")

        }

        function copy_literal_to_memory_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2() -> memPtr {
            memPtr := allocate_memory_array_t_string_memory_ptr(6)
            store_literal_in_memory_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2(add(memPtr, 32))
        }

        function convert_t_stringliteral_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2_to_t_string_memory_ptr() -> converted {
            converted := copy_literal_to_memory_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2()
        }

        function store_literal_in_memory_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca(memPtr) {

            mstore(add(memPtr, 0), "TKB")

        }

        function copy_literal_to_memory_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca() -> memPtr {
            memPtr := allocate_memory_array_t_string_memory_ptr(3)
            store_literal_in_memory_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca(add(memPtr, 32))
        }

        function convert_t_stringliteral_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca_to_t_string_memory_ptr() -> converted {
            converted := copy_literal_to_memory_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca()
        }
        ...
        /// @ast-id 77
        /// @src 49:1464:1557  "constructor() AERC20(\"TokenB\", \"TKB\") {..."
        function constructor_TokenB_78() {
            /// @src 49:1485:1493  "\"TokenB\""
            let _2_mpos := convert_t_stringliteral_9e28b3853f378e1414dd8a72fb1b762bb8980cd75a0b9480d2a46c1117cab7a2_to_t_string_memory_ptr()
            /// @src 49:1495:1500  "\"TKB\""
            let _3_mpos := convert_t_stringliteral_ab61f3e2f61f385e65f7207e097e9653b89415bafbaff742c9593231971161ca_to_t_string_memory_ptr()

            /// @src 49:1464:1557  "constructor() AERC20(\"TokenB\", \"TKB\") {..."
            constructor_AERC20_344(_2_mpos, _3_mpos)

            /// @src 49:1514:1524  "msg.sender"
            let expr_66 := caller()
            /// @src 49:1526:1530  "1000"
            let expr_67 := 0x03e8
            /// @src 49:1534:1536  "10"
            let expr_68 := 0x0a
            /// @src 49:1540:1550  "decimals()"
            let expr_70 := fun_decimals_1460()
            /// @src 49:1534:1550  "10 ** decimals()"
            let _4 := convert_t_rational_10_by_1_to_t_uint256(expr_68)
            let expr_71 := checked_exp_t_rational_10_by_1_t_uint8(expr_70)
            /// @src 49:1533:1551  "(10 ** decimals())"
            let expr_72 := expr_71
            /// @src 49:1526:1551  "1000 * (10 ** decimals())"
            let expr_73 := checked_mul_t_uint256(convert_t_rational_1000_by_1_to_t_uint256(expr_67), expr_72)

            fun__mint_1760(expr_66, expr_73)
    ...
    object "TokenB_78_deployed" {
        ...
        data ".metadata" hex"a26469706673582212207f3d68e7e67dee019c30ce9e8d096a8e7ccb0cdea0260aba875c41678b3766d964736f6c634300081e0033"
    }
