...
/// @use-src 0:"AERC20.sol", 34:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/token/ERC20/ERC20.sol", 35:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/token/ERC20/IERC20.sol", 42:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/utils/Context.sol"
object "AERC20_344" {
    code {
        /// @src 0:250:877  "contract AERC20 is ERC20 {..."
        mstore(64, memoryguard(128))
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        let _1, _2 := copy_arguments_for_constructor_293_object_AERC20_344()
        constructor_AERC20_344(_1, _2)

        let _3 := allocate_unbounded()
        codecopy(_3, dataoffset("AERC20_344_deployed"), datasize("AERC20_344_deployed"))

        return(_3, datasize("AERC20_344_deployed"))
        ...
        function copy_arguments_for_constructor_293_object_AERC20_344() -> ret_param_0, ret_param_1 {

            let programSize := datasize("AERC20_344")
        ...
        function constructor_AERC20_344(var_name_283_mpos, var_symbol_285_mpos) {
            /// @src 0:402:406  "name"
            let _4_mpos := var_name_283_mpos
            let expr_288_mpos := _4_mpos
            let _5_mpos := expr_288_mpos
            /// @src 0:408:414  "symbol"
            let _6_mpos := var_symbol_285_mpos
            let expr_289_mpos := _6_mpos
            let _7_mpos := expr_289_mpos

            /// @src 0:342:418  "constructor(string memory name, string memory symbol) ERC20(name, symbol) {}"
            constructor_ERC20_1884(_5_mpos, _7_mpos)
        ...
        function constructor_ERC20_1884(var_name__1415_mpos, var_symbol__1417_mpos) {
            ...
            let _8_mpos := var_name__1415_mpos
            let expr_1421_mpos := _8_mpos
            /// @src 34:2054:2067  "_name = name_"
            update_storage_value_offset_0_t_string_memory_ptr_to_t_string_storage(0x03, expr_1421_mpos)
            let _9_slot := 0x03
            let expr_1422_slot := _9_slot
            /// @src 34:2087:2094  "symbol_"
            let _10_mpos := var_symbol__1417_mpos
            let expr_1425_mpos := _10_mpos
            ...
            let _11_slot := 0x04
            let expr_1426_slot := _11_slot
            /// @src 34:2116:2118  "18"
            let expr_1429 := 0x12
            /// @src 34:2104:2118  "_decimals = 18"
            let _12 := convert_t_rational_18_by_1_to_t_uint8(expr_1429)
            update_storage_value_offset_0_t_uint8_to_t_uint8(0x05, _12)
            let expr_1430 := _12
    ...
    /// @use-src 0:"AERC20.sol", 2:"Yult.sol", 32:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/math/SafeMath.sol", 34:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/token/ERC20/ERC20.sol", 42:"openzeppelin-contracts-3.4.1-solc-0.7-2/contracts/utils/Context.sol"
    object "AERC20_344_deployed" {
        code {
            /// @src 0:250:877  "contract AERC20 is ERC20 {..."
            mstore(64, memoryguard(128))
        ...
        data ".metadata" hex"a26469706673582212201ecf361e8e90c7170f24347757b1c7e5d3429671d0b04b4381f85bbc13e6288a64736f6c634300081e0033"
    }
