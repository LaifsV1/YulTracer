 ...
 contract Rubixi {
         ...
         function addPayout(uint _fee) private {
                 ...
                 while (balance > participants[payoutOrder].payout) {
                         ...
                         bool res = payable(participants[payoutOrder].etherAddress).send(payoutToSend);
                         require(res);
         ...
         function collectAllFees() public onlyowner {
                 ...
                 bool res = payable(creator).send(collectedFees);
                 require(res);
                 collectedFees = 0;
         }
         ...
         function collectFeesInEther(uint _amt) public onlyowner {
                 ...
                 bool res = payable(creator).send(_amt);
                 require(res);
                 collectedFees -= _amt;
         }
         ...
         function collectPercentOfFees(uint _pcent) public onlyowner {
                 ...
                 bool res = payable(creator).send(feesToCollect);
                 require(res);
