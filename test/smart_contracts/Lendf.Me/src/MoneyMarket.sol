...
abstract contract PriceOracleInterface {
    ...
    /**
      ...
      */
    function assetPrices(address asset) public view virtual returns (uint);
}
...
abstract contract InterestRateModel {
    ...
    /**
      ...
      */
    function getSupplyRate(address asset, uint cash, uint borrows) public view virtual returns (uint, uint);
    ...
    /**
      ...
      */
    function getBorrowRate(address asset, uint cash, uint borrows) public view virtual returns (uint, uint);
}
...
contract MoneyMarket is Exponential, SafeToken {
    ...
    function liquidateBorrow(address targetAccount, address assetBorrow, address assetCollateral, uint requestedAmountClose) public returns (uint) {
        ...
        if (requestedAmountClose == type(uint256).max) {
