...
object "IndirectStorage_52" {
    code {
        ...
        function constructor_IndirectStorage_52() {
            ...
            /// @src 0:576:579  "600"
            let expr_46 := 0x0258
            /// @src 0:557:579  "storageSlots[3] == 600"
            let expr_47 := eq(cleanup_t_uint256(expr_45), convert_t_rational_600_by_1_to_t_uint256(expr_46))
            /// @src 0:550:580  "assert(storageSlots[3] == 600)"
    ...
    object "IndirectStorage_52_deployed" {
        ...
        data ".metadata" hex"a26469706673582212207ac271b50bb7f80e73c4520dc4caaae77638a76731615da989f49c7ad5ab61f964736f6c634300081c0033"
    }
