...
object "IndirectStorage_52" {
    code {
        ...
        function constructor_IndirectStorage_52() {
            ...
            /// @src 0:496:499  "200"
            let expr_30 := 0xc8
            /// @src 0:477:499  "storageSlots[1] == 200"
            let expr_31 := eq(cleanup_t_uint256(expr_29), convert_t_rational_200_by_1_to_t_uint256(expr_30))
            /// @src 0:470:500  "assert(storageSlots[1] == 200)"
    ...
    object "IndirectStorage_52_deployed" {
        ...
        data ".metadata" hex"a26469706673582212202215ed562d235192db68ff656794598b0c6833f0de666c2e8eb3adc2db03c63264736f6c634300081c0033"
    }
