...
object "IndirectStorage_52" {
    code {
        ...
        function cleanup_t_rational_600_by_1(value) -> cleaned {
            cleaned := value
        }

        function convert_t_rational_600_by_1_to_t_uint256(value) -> converted {
            converted := cleanup_t_uint256(identity(cleanup_t_rational_600_by_1(value)))
        }
        ...
        function constructor_IndirectStorage_52() {
            ...
            /// @src 0:536:539  "600"
            let expr_38 := 0x0258
            /// @src 0:517:539  "storageSlots[2] == 600"
            let expr_39 := eq(cleanup_t_uint256(expr_37), convert_t_rational_600_by_1_to_t_uint256(expr_38))
            /// @src 0:510:540  "assert(storageSlots[2] == 600)"
    ...
    object "IndirectStorage_52_deployed" {
        ...
        data ".metadata" hex"a2646970667358221220b14d71fe55eaf01431b33b55942dcb536de41683a15b2f38d7c08081db9ad59b64736f6c634300081c0033"
    }
