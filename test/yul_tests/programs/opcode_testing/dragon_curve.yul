...
object "Primes" {
    code {
        ...
        function dragon_curve(n) -> res {
            ...
            for {let i := false} lt(i,n) {i := add(i,1)}
            {
        ...
        printbin(dragon_curve(0))
        // 1_2
        // = 1_10
        printbin(dragon_curve(1))
        // 110_2
        // = 6_10
        printbin(dragon_curve(2))
        // 1101100_2
        // = 108_10
        printbin(dragon_curve(3))
        // 110110011100100_2
        // = 27876_10
        printbin(dragon_curve(4))
        // 1101100111001001110110001100100_2
        // = 1826942052_10
        printbin(dragon_curve(5))
        // 110110011100100111011000110010011101100111001000110110001100100_2
        // = 7846656369001524324_10
        printbin(dragon_curve(6))
